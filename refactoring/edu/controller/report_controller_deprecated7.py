...
if __name__ == '__main__':
    ...
    subject_order_value = ExamSubjectOrderValue(item_config.AVG_ITEM, QA_CODE, DISTRICT_CODE, exam, where)
    print_rows(subject_order_value.get_value())
    print()
    exam_order_value = SubjectExamOrderValue(item_config.AVG_ITEM, QA_CODE, DISTRICT_CODE, subject_id, exam, where)
    print_rows(exam_order_value.get_value())
